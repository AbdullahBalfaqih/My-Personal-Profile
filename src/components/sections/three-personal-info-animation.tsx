...
const ThreePersonalInfoAnimation = () => {
    ...
    useEffect(() => {
        ...
        const backgroundFragment = `
            ...
            void main() {    
                ...
                vec3 color = hsl2rgb(vec3(0.0 + n * 0.1, 0.0, 0.03));
        ...
        class THREEScene {
            ...
            render() {
                ...
                if (this.material) this.material.uniforms.u_time.value = time;
                if (this.pointsMaterial) this.pointsMaterial.uniforms.u_time.value = time;
                if (this.backgroundMaterial) this.backgroundMaterial.uniforms.u_time.value = time;
                if (this.points) this.points.rotation.y += 0.002;
            ...
            animate() {
                gsap.timeline({ repeat: -1, yoyo: true })
                    .to(this.material.uniforms.u_progress, { value: 5, duration: 5, ease: "power3.inOut" })
                    .to(this.material.uniforms.u_progress, { value: 1, duration: 5, ease: "power3.inOut" });
                
                gsap.to(this.pointsMaterial.uniforms.u_progress, { value: 0.4, duration: 5, ease: "power3.inOut" });
            }
    ...
    return (
        <div ref={containerRef} className="absolute inset-0 w-full h-full pointer-events-none opacity-60 mix-blend-screen" />
    );
};

export default ThreePersonalInfoAnimation;
